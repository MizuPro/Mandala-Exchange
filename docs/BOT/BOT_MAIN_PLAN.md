...
- **Tugas**:
  - [ ] **Task 0.1 — Trading Session Instance (BEI + MATS)**  
  ...
  - [ ] **Task 0.2 — Self-Trade Prevention (MATS)**  
  ...
  - [ ] **Task 0.3 — BOT Service Identity & Scope**  
...
- **Exit Criteria**:
  ...
  - [ ] Satu session rollover menghasilkan instance ID baru.
  - [ ] Genesis menghasilkan saldo Sekuritas dan custody BEI yang dapat direkonsiliasi.
  - [ ] Account event gap dapat dipulihkan dengan replay atau snapshot.
...
- **Tugas**:
  ...
  - [ ] **Task 1.3 — Versioned Database Migration**  
...
- **Exit Criteria**:
  ...
  - [ ] Service idle dapat start/stop bersih tanpa dependency nyata.
  - [ ] DB connection pool maksimum default 15.
